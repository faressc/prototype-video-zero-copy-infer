...
// producer's unpackUnorm4x8 exactly. The image may hold more texels
// than the tensor has elements (rows are padded to 64 bytes); the tail
// is not data.
...
fn main(@builtin(global_invocation_id) id : vec3<u32>) {
    ...
    o[idx] = bitcast<f32>(pack4x8unorm(t));
}
